...
const GlobalRerenderContext = createContext<
  GlobalRerenderContextType | undefined
>(undefined);
...
export const useGlobalRerender = () => {
  ...
  if (!context) {
    throw new Error(
      "useGlobalRerender must be used within a GlobalRerenderProvider"
    );
  }
  return context;
};

export const GlobalRerenderProvider: FCC<GlobalRerenderContextType> = ({
  children,
}) => {
